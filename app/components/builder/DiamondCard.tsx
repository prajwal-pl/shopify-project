...
export function DiamondCard({ stone, selected, onSelect }: DiamondCardProps) {
    ...
    return (
        <Card
            className={cn(
                "group relative overflow-hidden rounded-lg border border-stone-200 bg-white shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all duration-300",
                "hover:-translate-y-2 hover:shadow-[0_8px_24px_rgba(0,0,0,0.12)] hover:border-stone-300",
